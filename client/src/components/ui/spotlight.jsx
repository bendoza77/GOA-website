...
/**
 * Spotlight — animated radial light sweep (aceternity).
 * Converted to JavaScript. Relies on the `animate-spotlight` keyframe
 * defined in src/styles/animations.css.
 *
 * Props:
 *  - className: positioning overrides
 *  - fill:      ellipse colour (defaults to white; pass a brand green for GOA)
 */
