...
/**
 * Footer — sitemap, newsletter, socials + oversized brand watermark. (The
 * interactive robot finale now lives as the last section of the Home page —
 * see RobotShowcase — so its 3D cost stays out of the shared shell.)
 */
const Footer = () => {
